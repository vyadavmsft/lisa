...
$GlobalXML.Global.Azure.TestCredentials.LinuxAdminSshKey = $XmlSecrets.secrets.linuxAdminSshKey
...
$GlobalXML.Global.HyperV.TestCredentials.LinuxAdminSshKey = $XmlSecrets.secrets.linuxAdminSshKey
