...
check_exit_status "Execute mount -t nfs $nfsshare /mount/nfsshare -o rw,vers=$nfsversion,sec=sys,nconnect=$nconnect"
...
tar -xvf $file_name
check_exit_status "Execute tar -xvf $file_name"
popd
