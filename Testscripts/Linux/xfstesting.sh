...
excluded_tests="ext4/054 generic/211 generic/430 generic/431 generic/434 /xfs/438 xfs/490 btrfs/007 btrfs/178 btrfs/244"
...
Main() {
    ...
    if [[ $DISTRO_NAME == "centos" || $DISTRO_NAME == "rhel" || $DISTRO_NAME == "almalinux" || $DISTRO_NAME == "rockylinux" ]]; then
