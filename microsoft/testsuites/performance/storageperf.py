...
class StoragePerformance(TestSuite):  # noqa
    ...
    def _perf_nfs(
        ...
        server_partition_disks = format_disk(server_node, server_data_disks)
        stop_raid(server_node)
        make_raid(server_node, server_partition_disks)
    ...
    def _perf_premium_datadisks(
        ...
        partition_disks = format_disk(node, data_disks)
        stop_raid(node)
        make_raid(node, partition_disks)
